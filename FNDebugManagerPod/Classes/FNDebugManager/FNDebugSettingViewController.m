...
- (instancetype)init{
    self = [super initWithNibName:NSStringFromClass([self class]) bundle:[NSBundle debugManagerBundle]];
    _cid = [FNDebugManager shareManager].cid;
    _deviceToken = [FNDebugManager shareManager].deviceToken;
    return self;
}
